...
class PagerankUndirectedPrincetonTest : public ::testing::Test {
protected:
  virtual void SetUp() {
    ...
    stinger_insert_edge_pair(S,0,3,2,1,1);
  }
...
TEST_F(PagerankUndirectedPrincetonTest, Pagerank) {
...
TEST_F(PagerankUndirectedPrincetonTest, PagerankSubset) {
...
TEST_F(PagerankUndirectedPrincetonTest, PagerankType) {
  for (int i=10; i < 100; i++) {
    int64_t timestamp = i+1;
    for (int j=i+1; j < 100; j++) {
