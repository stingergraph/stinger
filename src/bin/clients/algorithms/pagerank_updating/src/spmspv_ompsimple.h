...
void
stinger_dspmTv_degscaled_ompsimple (const int64_t nv,
                          const double alpha, const struct stinger *S, const double * x,
                          const double beta, double * y);

void
stinger_unit_dspmTv_degscaled_ompsimple (const int64_t nv,
                               const double alpha, const struct stinger *S, const double * x,
                               const double beta, double * y);
...
void
stinger_dspmTspv_degscaled_ompsimple (const int64_t nv,
                            const double alpha, const struct stinger *S,
                            const int64_t x_deg, const int64_t * x_idx, const double * x_val,
                            const double beta,
                            int64_t * y_deg, int64_t * y_idx, double * y_val,
...
void
stinger_unit_dspmTspv_degscaled_ompsimple (const int64_t nv,
                                 const double alpha, const struct stinger *S,
                                 const int64_t x_deg, const int64_t * x_idx, const double * x_val,
                                 const double beta,
                                 int64_t * y_deg, int64_t * y_idx, double * y_val,
