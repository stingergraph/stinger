...
int64_t
stinger_vtype_names_create_type(stinger_t * S, char * name) {
  return stinger_names_create_type(stinger_vtype_names_get(S), name);
}
...
int64_t
stinger_etype_names_create_type(stinger_t * S, char * name) {
  return stinger_names_create_type(stinger_etype_names_get(S), name);
}
